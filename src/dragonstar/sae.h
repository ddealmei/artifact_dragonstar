...
struct sae_temporary_data {
	...
	size_t kck_len;
	struct crypto_bignum_static *own_commit_scalar;
	...
	struct crypto_bignum_static *sae_rand;
	struct crypto_ec *ec;
	int prime_len;
	int order_len;
	...
	struct crypto_bignum_static *prime_buf;
	struct crypto_bignum_static *order_buf;
...
struct sae_data {
	...
	struct crypto_bignum_static *peer_commit_scalar;
	struct crypto_bignum_static *peer_commit_scalar_accepted;
	int group;
